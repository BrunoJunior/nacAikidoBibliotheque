...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	...
	<head>
		...
		<title><?php echo $site; ?> - Supprimer un livre</title>
	...
	<body id="site-wrapper">
		...
		<div class="main" id="main-two-columns">
			...
			<div class="left" id="main-content">
				...
				<div class="success"><a href="admin.php">Administration</a> &rarr; <a href="livre_suppr.php">Supprimer un livre</a></div>
						...
						<?php
							...
							for($i=0;$i<count($array);$i++)
							{
								echo '<tr>';
									...
									echo '<td><a href="javascript: if (confirm(\'Voulez vous vraiment supprimer '.$array[$i]->getTitle().' ?\')) { window.location.href=\'livre_base.php?type=3&id='.$array[$i]->getId().'\' } else { void(\'\') };"><img src="img/delete.png" /></a></td>';
								echo '</tr>';
							}
						?>
					</tbody>

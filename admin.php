...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	...
	<head>
		...
		<title><?php echo $site; ?> - Administration</title>
	...
	<body id="site-wrapper">
		...
		<div class="main" id="main-two-columns">
			...
			<div class="left" id="main-content">
				...
				<img src="img/fleche.png"><h2 id="tadmin">&nbsp;Administration</h2>
				
				<br /><br />
				<form id="base">
					<fieldset>
						<legend>&nbsp;Gestion des livres&nbsp;</legend>
						<table>
							<tr>
				...
				<form id="membre">
					<fieldset>
						<legend>&nbsp;Gestion des membres et des emrpunts&nbsp;</legend>
						<table>
							<tr>
								<td><a href="gerer_membres.php"><img src="img/messagerie.png" /></a></td>
								<td><a href="livre_liste_attente.php"><img src="img/books.jpg" /></a></td>
								<td><a href="livre_liste_nondispo.php"><img src="img/books.jpg" /></a></td>
								<td><a href="livre_liste_emprunts.php"><img src="img/books.jpg" /></a></td>
							</tr>
							<tr>
								<td>Gérer les membres</td>
								<td>Demandes en attente</td>
								<td>Livres indisponibles</td>
								<td>Suivi des emprunts</td>
							</tr>
						</table>
					</fieldset>
				</form>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	...
	<head>
		...
		<title><?php echo $site; ?> - Livre à la une</title>
	...
	<body id="site-wrapper">
		...
		<div class="main" id="main-two-columns">
			...
			<div class="left" id="main-content">
				...
				<div class="success"><a href="admin.php">Administration</a> &rarr; <a href="livre_enreg.php">Livre à la une</a></div>
				
				<p>&nbsp;</p>
				<p>Merci de choisir le livre qui sera affiché sur la page d'accueil :</p>
				<p>&nbsp;</p>
						...
						<?php
							...
							for($i=0;$i<count($array);$i++)
							{
								echo '<tr>';
									...
									echo '<td><p style="text-align:center"><a href="livre_base.php?type=5&id='.$array[$i]->getId().'"><img src="img/accept.png" /></a></p></td>';
								echo '</tr>';
							}
						?>
					</tbody>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	...
	<head>
		...
		<title><?php echo $site; ?> - Modifier un livre</title>
	...
	<body id="site-wrapper">
		...
		<div class="main" id="main-two-columns">
			...
			<div class="left" id="main-content">
				...
				<div class="success"><a href="admin.php">Administration</a> &rarr; <a href="livre_edit.php">Modifier un livre</a></div>
						...
						<?php
							...
							for($i=0;$i<count($array);$i++)
							{
								echo '<tr>';
									...
									echo '<td><a href="livre_modif.php?id='.$array[$i]->getId().'"><img src="img/pencil_go.png" /></a></td>';
								echo '</tr>';
							}
						?>
					</tbody>

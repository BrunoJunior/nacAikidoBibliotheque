					...
					<fieldset>
						...
						<table>
									...
									<select name="genre" id="genre">
										...
										<?php
											for($i=0;$i<count($categories);$i++){
												...
												if($book->getGenre() == $i+1){echo 'selected';}
												echo '>';
							...
							<tr>
								...
								<td>
									<input type="text" name="proprietaire" id="proprietaire" class="text" value="<?php echo $book->getProprietaire(); ?>" />
								</td>
							</tr>
							...
							<tr>
								...
								<?php
									$etats = Livre::getEtats($bdd);
									$key = array_keys($etats);
								?>
									...
									<select name="disponibilite" id="disponibilite">
										...
										<?php
											for($i=0;$i<count($etats);$i++){
												echo '<option value="'.$key[$i].'" ';
												if($book->getId_etat() == $key[$i]){echo 'selected';}
												echo '>';
												echo $etats[$key[$i]].'</option>';
											}
										?>
									</select>

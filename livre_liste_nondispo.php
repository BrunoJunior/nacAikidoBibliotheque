...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	...
	<head>
		...
		<title><?php echo $site; ?> - Liste des livres non disponibles</title>
	...
	<body id="site-wrapper">
		...
		<div class="main" id="main-two-columns">
			...
			<div class="left" id="main-content">
				...
				<div class="success"><a href="admin.php">Administration</a> &rarr; <a href="livre_liste_emprunts.php">Liste des livres non disponibles</a></div>
				...
				<table cellspacing="1" class="tablesorter" id="tablesorter">
					...
					<tbody>
						<?php
							$array = Livre::getListIndispo($bdd);
